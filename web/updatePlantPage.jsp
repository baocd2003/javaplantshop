<%-- 
    ...
    Created on : Mar 18, 2023, 12:07:28 AM
    Author     : Admin
--%>
    ...
    <body>
         <c:choose>
            ...
            <c:otherwise>
                ...
                <form action="mainController" method="get" class="form-log" style="font-family:'Poppins', sans-serif;">
                    <table>
                        <tr>
                    ...
                    <input type="submit" name="action" value="updatePlant" class="log" style="margin-left: 36px;
    margin-top: 36px;"/>
                </form>
                <h3 style="margin-top: 36px;
    color: red;
    margin-left: 180px;">${requestScope.error}</h3>
                <footer>
